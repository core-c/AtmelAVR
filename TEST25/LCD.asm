...
LCD_LinePrintChar:
	...
	rcall	LCD_GetAddrCounter
	andi	temp, 0b01111111			; busy-flag strippen
	mov		temp2, temp
;	inc		temp2
	
	clr		temp3
	;
	cpi		temp, AddrLine0+19;$13		; cursor op laatste positie op 1e regel?
	brne	r2
	ldi		temp2, AddrLine1
	ser		temp3
	rjmp	rAPOP
r2:
	cpi		temp, AddrLine1+19;$53		; cursor op laatste positie op 2e regel?
	brne	r3
	ldi		temp2, AddrLine2
	ser		temp3
	rjmp	rAPOP
r3:
	cpi		temp, AddrLine2+19;$27		; cursor op laatste positie op 3e regel?
	brne	r4
	ldi		temp2, AddrLine3
	ser		temp3
	rjmp	rAPOP
r4:
	cpi		temp, AddrLine3+19;$67		; cursor op laatste positie op 4e regel?
	brne	rAPOP
	;clear LCD leuk hier?
	ldi		temp2, AddrLine0
	ser		temp3
rAPOP:
	...
	tst		temp3						; zelf cursor positie instellen??
	breq	Exit_LinePrintChar
	;De cursorpositie is van regelnummer veranderd door een overloop.
	; de nieuwe cursor positie "met de hand" plaatsen.
	mov		temp, temp2
	rcall	LCD_SetDisplayAddr
Exit_LinePrintChar:
	pop		temp2;!!
...
LCD_NextLine:
	...
	ldi		temp, AddrLine0
	rjmp	crA
cr2:; cursor nu nog ergens op de 2e regel?
	cpi		temp, AddrLine1
	brmi	cr3
	ldi		temp, AddrLine2
	rjmp	crA
cr3:; cursor nu nog ergens op de 3e regel?
	cpi		temp, AddrLine2
	brmi	cr1
	ldi		temp, AddrLine3
	rjmp	crA
cr1:; cursor nu nog ergens op de 1e regel
	ldi		temp, AddrLine1
crA:
...
;--- input: temp  = beginadres source
;---        temp2 = beginadres dest.
;---        temp3 = aantal tekens
;---------------------------------------
LCD_CopyLine:
	; cursor/knipperen uitschakelen

	; plaats cursor op source plaasten
	rcall	LCD_SetDisplayAddr


	; plaats cursor op dest. plaasten
