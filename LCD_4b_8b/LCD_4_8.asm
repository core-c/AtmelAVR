...
.else ;if DATA_LEN == 4
	...
	.equ LCD_CTRL_DDR	= DDRA				; Het Data-Direction-Register van de control-port
	;--- De control-lijnen -----------------
	.equ LCD_RS			= PC1				; RS op pin 5 van poort A
	.equ LCD_RW			= PC2				; RW op pin 6 van poort A
	.equ LCD_E			= PC3				; E op pin 7 van poort A
...
SplashText1: .db " 4b/8b LCD v0.900 ", EOS_Symbol
;--------------------------------------/
