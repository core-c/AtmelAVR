...
CChar0:	.dw	0b0000010000000100;2,1
		.dw	0b0000010000000000;4,3
		.dw	0b0000000000000000;6,5
...
;--  in programma(/flash)-geheugen
SplashText0: .db "   AVRASM2 Code   ", EOS_Symbol, 0
SplashText1: .db "   8b LCD v0.902  ", EOS_Symbol, 0
;--------------------------------------/
