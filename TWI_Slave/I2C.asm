...
.def TWI_Status		= R18				; TWI temporary SREG storage
.def TWI_Data		= R19				; TWI data register
.def TWI_Address	= R20				; TWI address and direction register




;--- Macros ---------------------------\
.MACRO InsertWaitState
	sbi		DDRD,DDD4					; start wait state
.ENDMACRO

.MACRO AssertWaitState
...
TWI_stop:
	...
	out		SREG,TWI_Status				; restore SREG
