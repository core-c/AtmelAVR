...
delay40us:								;41 micro-seconde (295 clockcycles)
	; een rcall instructie neemt 3 cycles in beslag	|	  1*3 =   3 +
	ldi		delay0, 96					; 1 cycle	|	  1*1 =   1 +
innerloop40us:
	dec		delay0						; 1 cycle	|	 96*1 =  96 +
	brne	innerloop40us				; 2 cycles	>	 95*2 = 190 +	;96 x wordt de branche genomen (springen = 2 cycles)
										; 1 cycle	|	  1*1 =   1 +	;bij de laatste branche wordt niet gesprongen (1 cycle)
	ret									; 4 cycles	|	  1*4 =   4
										;				-------------
										;				        295 clockcycles
