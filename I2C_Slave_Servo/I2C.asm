...
;--- input: TWI_Data
;---        1 byte: $00 = servo helemaal linksom
;---                $80 = servo in het midden
;---                $FF = servo helemaal rechtsom
;--------------------------------------\
InComingData:
	push	R16
...
MasterReadNext:
	...
	brcc	MasterReadNext				; na het ontvangen van een ACK meer bytes gaan ontvangen..
