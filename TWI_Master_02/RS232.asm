...
;----------------------------------------------\
.equ RS232_BufferSize = 32						; Buffer van 0x0060-0x0070 in SRAM (!!niet voorbij 256-byte boundry!!)
...
;------------------------------------------
InitString:
	.db 13,10, "I2C-Master running: TWI_Master_02.asm", 13,10, EOS_Character
;------------------------------------------
;--- zend een initstring
;------------------------------------------
