...
var glAccum : procedure(op: GLuint; value: GLfloat); stdcall;
    ...
    glCallLists : procedure(n: GLsizei; atype: GLenum; const lists); stdcall;
    ...
    glTexImage1D : procedure(target: GLenum; level, internalformat: GLint; width: GLsizei; border: GLint; format, atype: GLenum; const pixels); stdcall;
    glTexImage2D : procedure(target: GLenum; level, internalformat: GLint; width, height: GLsizei; border: GLint; format, atype: GLenum; const Pixels); stdcall;
...
//------------------------------------------------------------------------------
    ...
    gluBuild2DMipmaps : function(target: GLenum; components, width, height: GLint; format, atype: GLenum; const Data): GLint; stdcall;
...
initialization
  ...
  Set8087CW($133F);  {OpenGL floatingpoint exceptions off}
finalization
  CloseOpenGL;
  Set8087CW(Saved8087CW);  {restore floatingpoint control-word}
