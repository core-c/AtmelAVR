...
LCD_Init:
	...
	rcall	delay15ms					; tenminste 40 milli-seconde pauze..
	rcall	delay15ms					; ..na het inschakelen van de power (2.7V)
	rcall	delay15ms					; .. (15ms bij 4.5V)
