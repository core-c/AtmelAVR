...
;*************************************************************************************
;***
;***  Hardware-matige 9-bits PWM met output op pin D4 (OC1B)
;***
...
.equ TOP			= $1FF				; De TOP-waarde voor een 8-bits timer = 2^8 - 1
...
.equ COMPARE		= ((TOP+1)/2)-1		; 50% duty-cycle
...
RESET:
	...
	out		DDRC, temp
	ldi		temp, (1<<PINC2 | 1<<PINC1 | 0<<PINC0)
	out		PORTC, temp					; 2 LED's aan bij 9-bits PWM
	...
	ldi		temp, (1<<COM1B1 | 0<<COM1B0 | 1<<PWM11 | 0<<PWM10)
	out		TCCR1A, temp 

	; Timer1 clock instellen.
	ldi		temp, (1<<CS12 | 0<<CS11 | 1<<CS10)	; 0b00000101  clock/1024
;	ldi		temp, (1<<CS12 | 0<<CS11 | 0<<CS10)	; 0b00000101  clock/256
;	ldi		temp, (0<<CS12 | 1<<CS11 | 1<<CS10)	; 0b00000101  clock/64
;	ldi		temp, (0<<CS12 | 1<<CS11 | 0<<CS10)	; 0b00000101  clock/8
;	ldi		temp, (0<<CS12 | 0<<CS11 | 1<<CS10)	; 0b00000101  clock
	out		TCCR1B, temp
