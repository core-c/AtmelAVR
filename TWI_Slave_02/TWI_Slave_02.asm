...
.include "TWI_Buffers.asm"				; De I2C RingBuffer
.include "LCD_Commands.asm"				; LCD-Commando sub-routine's
.include "LCD_8.asm"					; De LCD sub-routine's
.include "I2C.asm"						; De I2C sub-routine's ZONDER interrupt-handlers (RonCode)
;--------------------------------------/
...
RESET:
	...
	rcall	TWI_Initialize_Buffers		; De RingBuffers tbv. I2C-I/O initialiseren
